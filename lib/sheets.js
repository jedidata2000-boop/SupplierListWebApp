...
async function uploadPhoto(spreadsheetId, data) {
  const { supplierName, rowIndex, imageBase64, mimeType } = data;
  ...
  const uploadRes = await drive.files.create({
    requestBody: { name: `${supplierName}_row${rowIndex}`, mimeType: mimeType || 'image/jpeg' },
...
module.exports = {
  ...
  getOrders, addOrder, updateOrder, deleteOrder, addOrdersBulk,
  uploadPhoto,
